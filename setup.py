...
setup(name='docassemble.ePrivacy',
      version='0.0.1',
      description=('Questions to determine whether the \
              ePrivacy Directive applies in your case.'),
      long_description='# docassemble.ePrivacy\n\n\
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/ePrivacy/',\
                                     package='docassemble.ePrivacy'),
     )
